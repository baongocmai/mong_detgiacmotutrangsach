...
function Genre() {
  ...
  return (
    ...
    <div className="featured-wrapper">
      <button className="bun tagbooks"><h2 className="section-title">GỢI Ý CHO BẠN</h2></button>
      ...
      <div className="featured-wrapper">
      <button className="bun tagbooks"><h2 className="section-title">VĂN HỌC NƯỚC NGOÀI NỔI BẬT</h2></button>
      <div className="featured-section">
        <Slider {...settings}>
          {books.map((book, index) => (
            <div className="book-card" key={index}>
    ...
    <div className="featured-wrapper">
      <button className="bun tagbooks"><h2 className="section-title">VĂN HỌC NƯỚC NGOÀI MỚI</h2></button>
      <div className="featured-section">
        <Slider {...settings}>
          {books.map((book, index) => (
            <div className="book-card" key={index}>
